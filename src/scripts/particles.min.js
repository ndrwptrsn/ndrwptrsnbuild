...
var pJS = function(tag_id, params){
  ...
  pJS.fn.particle = function(color, opacity, position){
    ...
    if(this.shape == 'image'){
      let image = pJS.particles.shape.image;
      ...
      if (image instanceof Array) {
        ...
        if (counter < 10) {
          ...
          image = image[Math.floor(Math.random() * 5)];

        } else if ( counter >= 10 && counter <= 20) {

          image = image[Math.floor(Math.random() * 5) + 5];

        } else if ( counter > 20 && counter <= 30) {

          image = image[image.length - 6];

        } else if ( counter > 30 && counter <= 40) {

          image = image[image.length - 5];

        } else if ( counter > 40 && counter <= 50)  {

          image = image[Math.floor(Math.random() * 3) + (image.length - 3)];
